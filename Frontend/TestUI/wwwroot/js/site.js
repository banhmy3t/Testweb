document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('artist-calendar-visibility-save-database').addEventListener('click', function () {
        ...
        if (form.style.display === 'block') {
            ...
            fetch('https://themusicali.com:5000/ArtistCalendar/api/ArtistCalendarGigVisibilityAPI', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.getElementById('view-gig-from-database').addEventListener('click', function () {
        ...
        if (form.style.display === 'block') {
            ...
            url = 'https://themusicali.com:5000/ArtistCalendar/api/ArtistCalendarGigViewAPI?' + queryView.toString();
            fetch(url, {
                method: 'GET',
            })
                .then(response => {
    ...
    document.getElementById('delete-gig-from-database').addEventListener('click', function () {
        ...
        if (form.style.display === 'block') {
            ...
            fetch('https://themusicali.com:5000/ArtistCalendar/api/ArtistCalendarGigDeletionAPI', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.getElementById('update-gig-save-database').addEventListener('click', function () {
        ...
        if (form.style.display === 'block') {
            ...
            fetch('https://themusicali.com:5000/ArtistCalendar/api/ArtistCalendarGigUpdateAPI', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.getElementById('create-gig-save-database').addEventListener('click', function () {
        ...
        if (form.style.display === 'block') {
            ...
            fetch('https://themusicali.com:5000/ArtistCalendar/api/ArtistCalendarGigCreationAPI', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
